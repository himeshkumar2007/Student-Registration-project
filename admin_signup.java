	...
	admin_signup()
	{
		...
		signin.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				{
					JOptionPane.showMessageDialog(admin_signup.this, "please fill the entries");
				}
				try
				{
					Class.forName("com.mysql.cj.jdbc.Driver");
					Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/himesh1", "root", "");
					String query="insert into teacher(username,Name,email,PASSWORD,Phone_number) values(?,?,?,?,?)";
					...
					if(i==1)
					{
						JOptionPane.showMessageDialog(admin_signup.this, "successfull");
						Student_login.main(new String[] {});
						dispose();
					}
					else
					{
						JOptionPane.showMessageDialog(admin_signup.this, "failed");
					}
